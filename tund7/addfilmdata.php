 ...
 <img src="../img/vp_banner.png" alt="Veebiprogrammeerimise kursuse banner">
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<label for="firstnameinput">Eesnimi: </label>
	  <input type="text" name="firstnameinput" placeholder="" <?php if(!empty($firstname)) {echo 'value="' .$firstname .'"';} ?>>
	  <span><?php echo $firstnameerror; ?></span>
	  <br>
	<label for="lastnameinput">Perenimi: </label>
	  <input type="text" name="lastnameinput" placeholder="" <?php if(!empty($lastname)){echo 'value="' .$lastname .'"';} ?>>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<label for="movienameinput">Filmi nimi: </label>
	  <input type="text" name="movienameinput" placeholder="" <?php if(!empty($moviename)){echo 'value="' .$moviename .'"';} ?>>
	...
	<label for="descriptioninput">Kirjeldus: </label>
	  <br>
	  <textarea rows="7" cols="60" name="descriptioninput" id="descriptioninput" placeholder=""><?php if(!empty($description)) {echo $description;} ?></textarea>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<label for="positionnameinput">Positsioon: </label>
	  <input type="text" name="positionnameinput" placeholder="" <?php if(!empty($positionname)){echo 'value="' .$positionname .'"';} ?>>
	  <span><?php echo $positionnameerror; ?></span>
	  <br>
	<label for="positiondescriptioninput">Positsiooni kirjeldus: </label>
	  <br>
	  <textarea rows="5" cols="40" name="positiondescriptioninput" id="positiondescriptioninput" placeholder=""><?php if(!empty($positiondescription)) {echo $positiondescription;} ?></textarea>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<label for="genreinput">Žanr: </label>
	  <input type="text" name="genreinput" placeholder="" <?php if(!empty($genre)){echo 'value="' .$genre .'"';} ?>>
	  <span><?php echo $genreerror; ?></span>
	  <br>
	<label for="genredescriptioninput">Žanri kirjeldus: </label>
	  <br>
	  <textarea rows="5" cols="40" name="genredescriptioninput" id="genredescriptioninput" placeholder=""><?php if(!empty($genredescription)) {echo $genredescription;} ?></textarea>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<label for="companynameinput">Filmitootja: </label>
	  <input type="text" name="companynameinput" placeholder="" <?php if(!empty($companyname)){echo 'value="' .$companyname .'"';} ?>>
	  <span><?php echo $companynameerror; ?></span>
	  <br>
	<label for="companyaddressinput">Tootja aadress: </label>
	  <input type="text" name="companyaddressinput" placeholder="" <?php if(!empty($companyaddress)){echo 'value="' .$companyaddress .'"';} ?>>
