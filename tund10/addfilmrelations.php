...
?>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<input type="text" name="roleinput" placeholder="Roll" <?php if(!empty($role)){echo 'value="' .$role .'"';} ?>>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<select name="studioinput">
		<option value="" selected disabled>Vali stuudio</option>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<label for="quoteinput">Tsitaat:</label>
	  <input type="text" name="quoteinput" placeholder="Tsitaat" <?php if(!empty($quote)){echo 'value="' .$quote .'"';} ?>>
